...
{
    public partial class AddReservaComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            reserva = new A2019128143.Models.BibliotecaDb.Reserva(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(A2019128143.Models.BibliotecaDb.Reserva args)
        {
            try
            {
                var bibliotecaDbCreateReservaResult = await BibliotecaDb.CreateReserva(reserva);
                DialogService.Close(reserva);
            }
            catch (System.Exception bibliotecaDbCreateReservaException)
            {
                NotificationService.Notify(new NotificationMessage(){ Severity = NotificationSeverity.Error,Summary = $"Error",Detail = $"Unable to create new Reserva!" });
            }
        }
