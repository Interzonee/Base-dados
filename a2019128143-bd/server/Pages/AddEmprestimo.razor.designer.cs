...
{
    public partial class AddEmprestimoComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            emprestimo = new A2019128143.Models.BibliotecaDb.Emprestimo(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(A2019128143.Models.BibliotecaDb.Emprestimo args)
        {
            try
            {
                var bibliotecaDbCreateEmprestimoResult = await BibliotecaDb.CreateEmprestimo(emprestimo);
                DialogService.Close(emprestimo);
            }
            catch (System.Exception bibliotecaDbCreateEmprestimoException)
            {
                NotificationService.Notify(new NotificationMessage(){ Severity = NotificationSeverity.Error,Summary = $"Error",Detail = $"Unable to create new Emprestimo!" });
            }
        }
