...
{
    public partial class AddNotificacoComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            notificaco = new A2019128143.Models.BibliotecaDb.Notificaco(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(A2019128143.Models.BibliotecaDb.Notificaco args)
        {
            try
            {
                var bibliotecaDbCreateNotificacoResult = await BibliotecaDb.CreateNotificaco(notificaco);
                DialogService.Close(notificaco);
            }
            catch (System.Exception bibliotecaDbCreateNotificacoException)
            {
                NotificationService.Notify(new NotificationMessage(){ Severity = NotificationSeverity.Error,Summary = $"Error",Detail = $"Unable to create new Notificaco!" });
            }
        }
